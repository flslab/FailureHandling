...
# # ax.legend()
# # plt.show(dpi=500)
# plt.savefig(f"/Users/shuqinzhu/Desktop/obstruct_percentage_changed.png", dpi=500)
# plt.close()
#
#
#
...
# # ax.legend()
# # plt.show(dpi=500)
# plt.savefig(f"/Users/shuqinzhu/Desktop/illum_move_percentage_changed.png", dpi=500)
# plt.close()
#
#
#
...
# # ax.legend()
# # plt.show(dpi=500)
# plt.savefig(f"/Users/shuqinzhu/Desktop/standby_move_percentage_changed.png", dpi=500)
# plt.close()
#
#
#
...
# # ax.legend()
# # plt.show(dpi=500)
# plt.savefig(f"/Users/shuqinzhu/Desktop/dragon_standby_move_percentage_changed.png", dpi=500)
# plt.close()
#
#
# fig = plt.figure(figsize=(5, 3), layout='constrained')
...
# ax.legend()
# plt.show(dpi=500)
plt.savefig(f"/Users/shuqinzhu/Desktop/skateboard_CANF_kmeans_MTID.png", dpi=500)
plt.close()