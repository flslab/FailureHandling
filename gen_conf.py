...
general_props = [
    {
        ...
        "values": [
            ...
            # {"SHAPE": "'butterfly'", "K": "3", "INPUT": "'butterfly_G3'", "DISPATCHERS": "1", "DISPATCH_RATE": "60",
            #  "FAILURE_TIMEOUT": "30", "MAX_SPEED": "3", "ACCELERATION": "3", "DECELERATION": "3",
            #  "PRIORITIZE_ILLUMINATING_FLS": "True", "RESULTS_PATH": "'/proj/nova-PG0/shuqin/results/'",
            #  "CEDED_POLICY": "0", "DISPLAY_CELL_SIZE": "0.1619", "NAME": "'100_pri'"},
            # {"SHAPE": "'butterfly'", "K": "5", "INPUT": "'butterfly_G5'", "DISPATCHERS": "1", "DISPATCH_RATE": "60",
            #  "FAILURE_TIMEOUT": "30", "MAX_SPEED": "3", "ACCELERATION": "3", "DECELERATION": "3",
            #  "PRIORITIZE_ILLUMINATING_FLS": "True", "RESULTS_PATH": "'/proj/nova-PG0/shuqin/results/'",
            #  "CEDED_POLICY": "0", "DISPLAY_CELL_SIZE": "0.1619", "NAME": "'100_pri'"},
            # {"SHAPE": "'butterfly'", "K": "10", "INPUT": "'butterfly_G10'", "DISPATCHERS": "1", "DISPATCH_RATE": "60",
            #  "FAILURE_TIMEOUT": "30", "MAX_SPEED": "3", "ACCELERATION": "3", "DECELERATION": "3",
            #  "PRIORITIZE_ILLUMINATING_FLS": "True", "RESULTS_PATH": "'/proj/nova-PG0/shuqin/results/'",
            #  "CEDED_POLICY": "0", "DISPLAY_CELL_SIZE": "0.1619", "NAME": "'100_pri'"},
            # {"SHAPE": "'butterfly'", "K": "20", "INPUT": "'butterfly_G20'", "DISPATCHERS": "1", "DISPATCH_RATE": "60",
            #  "FAILURE_TIMEOUT": "30", "MAX_SPEED": "3", "ACCELERATION": "3", "DECELERATION": "3",
            #  "PRIORITIZE_ILLUMINATING_FLS": "True", "RESULTS_PATH": "'/proj/nova-PG0/shuqin/results/'",
            #  "CEDED_POLICY": "0", "DISPLAY_CELL_SIZE": "0.1619", "NAME": "'100_pri'"},
            #
            ...
            #  "FAILURE_TIMEOUT": "30", "MAX_SPEED": "3", "ACCELERATION": "3", "DECELERATION": "3",
            #  "PRIORITIZE_ILLUMINATING_FLS": "True", "RESULTS_PATH": "'/proj/nova-PG0/shuqin/results/'",
            #  "CEDED_POLICY": "0", "DISPLAY_CELL_SIZE": "0.001619", "NAME": "'monarch_pri'"},
            # # {"SHAPE": "'butterfly'", "K": "3", "INPUT": "'butterfly_G3'", "DISPATCHERS": "1", "DISPATCH_RATE": "60",
            # #  "FAILURE_TIMEOUT": "30", "MAX_SPEED": "3", "ACCELERATION": "3", "DECELERATION": "3",
            # #  "PRIORITIZE_ILLUMINATING_FLS": "True", "RESULTS_PATH": "'/proj/nova-PG0/shuqin/results/'",
            # #  "CEDED_POLICY": "0", "DISPLAY_CELL_SIZE": "0.001619", "NAME": "'monarch_pri'"},
            ...
            #  "FAILURE_TIMEOUT": "30", "MAX_SPEED": "3", "ACCELERATION": "3", "DECELERATION": "3",
            #  "PRIORITIZE_ILLUMINATING_FLS": "True", "RESULTS_PATH": "'/proj/nova-PG0/shuqin/results/'",
            #  "CEDED_POLICY": "0", "DISPLAY_CELL_SIZE": "0.01619", "NAME": "'10_pri'"},
            # {"SHAPE": "'butterfly'", "K": "3", "INPUT": "'butterfly_G3'", "DISPATCHERS": "1", "DISPATCH_RATE": "60",
            #  "FAILURE_TIMEOUT": "30", "MAX_SPEED": "3", "ACCELERATION": "3", "DECELERATION": "3",
            #  "PRIORITIZE_ILLUMINATING_FLS": "True", "RESULTS_PATH": "'/proj/nova-PG0/shuqin/results/'",
            #  "CEDED_POLICY": "0", "DISPLAY_CELL_SIZE": "0.01619", "NAME": "'10_pri'"},
            ...
            #  "PRIORITIZE_ILLUMINATING_FLS": "True", "RESULTS_PATH": "'/proj/nova-PG0/shuqin/results/'",
            #  "CEDED_POLICY": "0", "DISPLAY_CELL_SIZE": "0.05", "NAME": "'pri30'"},
            #
            # {"SHAPE": "'dragon'", "K": "3", "INPUT": "'dragon_G3'", "DISPATCHERS": "1", "DISPATCH_RATE": "10",
            #  "FAILURE_TIMEOUT": "60", "MAX_SPEED": "6.11", "ACCELERATION": "6.11", "DECELERATION": "6.11",
            ...
            {"SHAPE": "'dragon'", "K": "0", "INPUT": "'dragon_G3'", "DISPATCHERS": "1", "DISPATCH_RATE": "10",
             "FAILURE_TIMEOUT": "60", "MAX_SPEED": "12", "ACCELERATION": "12", "DECELERATION": "12",
             "PRIORITIZE_ILLUMINATING_FLS": "True", "RESULTS_PATH": "'/proj/nova-PG0/shuqin/results/'",
             "CEDED_POLICY": "0", "DISPLAY_CELL_SIZE": "0.05", "NAME": "'pri30'"},
            {"SHAPE": "'dragon'", "K": "3", "INPUT": "'dragon_G3'", "DISPATCHERS": "1", "DISPATCH_RATE": "10",
             "FAILURE_TIMEOUT": "60", "MAX_SPEED": "12", "ACCELERATION": "12", "DECELERATION": "12",
             "PRIORITIZE_ILLUMINATING_FLS": "True", "RESULTS_PATH": "'/proj/nova-PG0/shuqin/results/'",
             "CEDED_POLICY": "0", "DISPLAY_CELL_SIZE": "0.05", "NAME": "'pri30'"},
            {"SHAPE": "'dragon'", "K": "5", "INPUT": "'dragon_G5'", "DISPATCHERS": "1", "DISPATCH_RATE": "10",
             "FAILURE_TIMEOUT": "60", "MAX_SPEED": "12", "ACCELERATION": "12", "DECELERATION": "12",
             "PRIORITIZE_ILLUMINATING_FLS": "True", "RESULTS_PATH": "'/proj/nova-PG0/shuqin/results/'",
             "CEDED_POLICY": "0", "DISPLAY_CELL_SIZE": "0.05", "NAME": "'pri30'"},
            {"SHAPE": "'dragon'", "K": "10", "INPUT": "'dragon_G10'", "DISPATCHERS": "1", "DISPATCH_RATE": "10",
             "FAILURE_TIMEOUT": "60", "MAX_SPEED": "12", "ACCELERATION": "12", "DECELERATION": "12",
             "PRIORITIZE_ILLUMINATING_FLS": "True", "RESULTS_PATH": "'/proj/nova-PG0/shuqin/results/'",
             "CEDED_POLICY": "0", "DISPLAY_CELL_SIZE": "0.05", "NAME": "'pri30'"},
            # {"SHAPE": "'dragon'", "K": "15", "INPUT": "'dragon_G15'", "DISPATCHERS": "1", "DISPATCH_RATE": "10",
            #  "FAILURE_TIMEOUT": "60", "MAX_SPEED": "12", "ACCELERATION": "12", "DECELERATION": "12",
            #  "PRIORITIZE_ILLUMINATING_FLS": "True", "RESULTS_PATH": "'/proj/nova-PG0/shuqin/results/'",
            #  "CEDED_POLICY": "0", "DISPLAY_CELL_SIZE": "0.05", "NAME": "'pri30'"},
            {"SHAPE": "'dragon'", "K": "20", "INPUT": "'dragon_G20'", "DISPATCHERS": "1", "DISPATCH_RATE": "10",
             "FAILURE_TIMEOUT": "60", "MAX_SPEED": "12", "ACCELERATION": "12", "DECELERATION": "12",
             "PRIORITIZE_ILLUMINATING_FLS": "True", "RESULTS_PATH": "'/proj/nova-PG0/shuqin/results/'",
             "CEDED_POLICY": "0", "DISPLAY_CELL_SIZE": "0.05", "NAME": "'pri30'"},
            ...
            {"SHAPE": "'skateboard'", "K": "3", "INPUT": "'skateboard_G3'", "DISPATCHERS": "1", "DISPATCH_RATE": "30",
             ...
             "PRIORITIZE_ILLUMINATING_FLS": "True", "RESULTS_PATH": "'/proj/nova-PG0/shuqin/results/'",
             "CEDED_POLICY": "0", "DISPLAY_CELL_SIZE": "0.05", "NAME": "'prikmeans'"},
            {"SHAPE": "'skateboard'", "K": "5", "INPUT": "'skateboard_G5'", "DISPATCHERS": "1", "DISPATCH_RATE": "30",
             "FAILURE_TIMEOUT": "60", "MAX_SPEED": "6.11", "ACCELERATION": "6.11", "DECELERATION": "6.11",
             "PRIORITIZE_ILLUMINATING_FLS": "True", "RESULTS_PATH": "'/proj/nova-PG0/shuqin/results/'",
             "CEDED_POLICY": "0", "DISPLAY_CELL_SIZE": "0.05", "NAME": "'prikmeans'"},
            {"SHAPE": "'skateboard'", "K": "10", "INPUT": "'skateboard_G10'", "DISPATCHERS": "1", "DISPATCH_RATE": "30",
             "FAILURE_TIMEOUT": "60", "MAX_SPEED": "6.11", "ACCELERATION": "6.11", "DECELERATION": "6.11",
             "PRIORITIZE_ILLUMINATING_FLS": "True", "RESULTS_PATH": "'/proj/nova-PG0/shuqin/results/'",
             "CEDED_POLICY": "0", "DISPLAY_CELL_SIZE": "0.05", "NAME": "'prikmeans'"},
            {"SHAPE": "'skateboard'", "K": "20", "INPUT": "'skateboard_G20'", "DISPATCHERS": "1", "DISPATCH_RATE": "30",
             "FAILURE_TIMEOUT": "60", "MAX_SPEED": "6.11", "ACCELERATION": "6.11", "DECELERATION": "6.11",
             "PRIORITIZE_ILLUMINATING_FLS": "True", "RESULTS_PATH": "'/proj/nova-PG0/shuqin/results/'",
             "CEDED_POLICY": "0", "DISPLAY_CELL_SIZE": "0.05", "NAME": "'prikmeans'"},

            {"SHAPE": "'skateboard'", "K": "0", "INPUT": "'skateboard_K3'", "DISPATCHERS": "1", "DISPATCH_RATE": "30",
             "FAILURE_TIMEOUT": "60", "MAX_SPEED": "6.11", "ACCELERATION": "6.11", "DECELERATION": "6.11",
             "PRIORITIZE_ILLUMINATING_FLS": "True", "RESULTS_PATH": "'/proj/nova-PG0/shuqin/results/'",
             "CEDED_POLICY": "0", "DISPLAY_CELL_SIZE": "0.05", "NAME": "'priCANF'"},
            {"SHAPE": "'skateboard'", "K": "3", "INPUT": "'skateboard_K3'", "DISPATCHERS": "1", "DISPATCH_RATE": "30",
             "FAILURE_TIMEOUT": "60", "MAX_SPEED": "6.11", "ACCELERATION": "6.11", "DECELERATION": "6.11",
             "PRIORITIZE_ILLUMINATING_FLS": "True", "RESULTS_PATH": "'/proj/nova-PG0/shuqin/results/'",
             "CEDED_POLICY": "0", "DISPLAY_CELL_SIZE": "0.05", "NAME": "'priCANF'"},
            {"SHAPE": "'skateboard'", "K": "5", "INPUT": "'skateboard_K5'", "DISPATCHERS": "1", "DISPATCH_RATE": "30",
             "FAILURE_TIMEOUT": "60", "MAX_SPEED": "6.11", "ACCELERATION": "6.11", "DECELERATION": "6.11",
             "PRIORITIZE_ILLUMINATING_FLS": "True", "RESULTS_PATH": "'/proj/nova-PG0/shuqin/results/'",
             "CEDED_POLICY": "0", "DISPLAY_CELL_SIZE": "0.05", "NAME": "'priCANF'"},
            {"SHAPE": "'skateboard'", "K": "10", "INPUT": "'skateboard_K10'", "DISPATCHERS": "1", "DISPATCH_RATE": "30",
             "FAILURE_TIMEOUT": "60", "MAX_SPEED": "6.11", "ACCELERATION": "6.11", "DECELERATION": "6.11",
             "PRIORITIZE_ILLUMINATING_FLS": "True", "RESULTS_PATH": "'/proj/nova-PG0/shuqin/results/'",
             "CEDED_POLICY": "0", "DISPLAY_CELL_SIZE": "0.05", "NAME": "'priCANF'"},
            {"SHAPE": "'skateboard'", "K": "20", "INPUT": "'skateboard_K20'", "DISPATCHERS": "1", "DISPATCH_RATE": "30",
             "FAILURE_TIMEOUT": "60", "MAX_SPEED": "6.11", "ACCELERATION": "6.11", "DECELERATION": "6.11",
             "PRIORITIZE_ILLUMINATING_FLS": "True", "RESULTS_PATH": "'/proj/nova-PG0/shuqin/results/'",
             "CEDED_POLICY": "0", "DISPLAY_CELL_SIZE": "0.05", "NAME": "'priCANF'"},
            ...
            #  # "FAILURE_TIMEOUT": "30", "MAX_SPEED": "6.11", "ACCELERATION": "6.11", "DECELERATION": "6.11",
            #  # "PRIORITIZE_ILLUMINATING_FLS": "True", "RESULTS_PATH": "'/proj/nova-PG0/shuqin/results/'",
            #  # "CEDED_POLICY": "0", "DISPLAY_CELL_SIZE": "0.016", "NAME": "'child_pri'"},
            # {"SHAPE": "'racecar'", "K": "3", "INPUT": "'racecar_K3'", "DISPATCHERS": "1", "DISPATCH_RATE": "350",
            #  "FAILURE_TIMEOUT": "30", "MAX_SPEED": "6.11", "ACCELERATION": "6.11", "DECELERATION": "6.11",
            #  "PRIORITIZE_ILLUMINATING_FLS": "True", "RESULTS_PATH": "'/proj/nova-PG0/shuqin/results/'",
            #  "CEDED_POLICY": "0", "DISPLAY_CELL_SIZE": "0.016", "NAME": "'child_pri'"},
