...
general_props = [
    {
        ...
        "values": [
            ...
            # {"SHAPE": "'dragon'", "K": "10", "INPUT": "'dragon_K10'", "DISPATCHERS": "1", "DISPATCH_RATE": "20",
            #  "FAILURE_TIMEOUT": "30", "MAX_SPEED": "6.11", "ACCELERATION": "6.11", "DECELERATION": "6.11",
            #  "PRIORITIZE_ILLUMINATING_FLS": "False", "RESULTS_PATH": "'/proj/nova-PG0/shuqin/results/'",
            #  "CEDED_POLICY": "0", "DISPLAY_CELL_SIZE": "0.00052632", "NAME": "'standard'"},
            # {"SHAPE": "'dragon'", "K": "20", "INPUT": "'dragon_K20'", "DISPATCHERS": "1", "DISPATCH_RATE": "20",
            #  "FAILURE_TIMEOUT": "30", "MAX_SPEED": "6.11", "ACCELERATION": "6.11", "DECELERATION": "6.11",
            #  "PRIORITIZE_ILLUMINATING_FLS": "False", "RESULTS_PATH": "'/proj/nova-PG0/shuqin/results/'",
            #  "CEDED_POLICY": "0", "DISPLAY_CELL_SIZE": "0.00052632", "NAME": "'standard'"},
            #
            # {"SHAPE": "'dragon'", "K": "0", "INPUT": "'dragon_K3'", "DISPATCHERS": "1", "DISPATCH_RATE": "20",
            #  "FAILURE_TIMEOUT": "30", "MAX_SPEED": "6.11", "ACCELERATION": "6.11", "DECELERATION": "6.11",
            #  "PRIORITIZE_ILLUMINATING_FLS": "False", "RESULTS_PATH": "'/proj/nova-PG0/shuqin/results/'",
